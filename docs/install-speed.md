...
[Follow-up run 33991603136](https://github.com/ryankirkman/omarchy/actions/runs/33991603136), started September 5, 2026, is in progress at this update. It selects firmware boot, verified cold source pages and three variants: the upstream image path with the restore correction, package prefetch disabled, and prefetch disabled plus the [release-gated reboot experiment](../test/benchmarks/install-speed/fast-reboot/README.md). Each variant receives three fresh alternating control/candidate pairs. No result from that run is claimed here.
